...
interface ModuleDialogProps {
    ...
    onEditAssignment: () => Promise<void>;
}

export default function EditAssignmentDialog(
    { assignmentId, assignmentName, assignmentWeight, assignmentGrade, onEditAssignment }: ModuleDialogProps) {
    ...
    const [newAssignmentGrade, setAssignmentGrade] = useState(assignmentGrade);
                            ...
                            <div className="inline-block align-bottom bg-base-100 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                                ...
                                <div className="px-6 py-4">
                                    <label className="input input-bordered flex items-center gap-2">
                                        Name
                                        <input type="text" value={newAssignmentName} onChange={(e) => setAssignmentName(e.target.value)} className="grow" placeholder="Assignment Name" />
                                    </label>
